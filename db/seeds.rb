...
User.create(username: 'iuriseara', name: 'Iuri', password: 'password', img: 'https://suryahospitals.com/jaipur/wp-content/uploads/sites/3/2020/07/user-dummy-200x200-1.png')
...
Task.create(name: 'Belongs To One', description: 'Test Description', start_time: '10:00', end_time: '11:00', user_id: 1, category_id: 1)
...
Task.create(name: 'Belongs Two Two', description: 'Test Description', start_time: '9:00', end_time: '10:00', user_id: 1, category_id: 2)

Task.create(name: 'Belongs To Three', description: 'Test Description', start_time: '9:00', end_time: '10:00', user_id: 1, category_id: 3)
...
Task.create(name: '4 TEST', description: 'Test Description', start_time: '9:00', end_time: '10:00', user_id: 1, category_id: 4)
